...
export const New: React.FC<Props> = ({ hover, setHover, isCreatingRequest, isCreatingFolder, setIsCreatingFolder, setIsCreatingRequest }: Props) => {
  ...
  return (
    <>
      <div className={style.New} onMouseOver={() => setHover(true)} onMouseOut={() => setHover(false)}>
        <div className={style.notHover + ' ' + (!hover ? style.showNotHover : '')}>
          <span>New</span>
          <Add />
        </div>
      ...
      {isCreatingFolder && (
        <div className={style.createFolder + ' ' + (isCreatingFolder ? style.shown : '')}>
          <p>
          ...
          <form
            ...
            <div className={style.row}>
              ...
              <input ref={folderNameRef} type="text" name="createFolderInput" id="createFolderInput" placeholder="Folder name" />
            </div>
      ...
      {isCreatingRequest && (
        <div className={style.createRequest + ' ' + (isCreatingRequest ? style.shown : '')}>
          <p>
          ...
          <form
            ...
            <div className={style.row}>
              ...
              <input ref={requestNameRef} type="text" name="createRequestInput" id="createRequestInput" placeholder="Request name" />
            </div>
            <button tabIndex={-1} type="submit">
              Create Request
            </button>
